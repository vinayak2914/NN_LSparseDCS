...
seed(rand_seed)
output_dir = ('DeepcsTF2_m%d_spr%d'% (num_measurements,num_latents))
...
# Model Saving
    if (epoch + 1) % 10 == 0:
        filename1 = os.getcwd()+'/DeepcsTF2_m%d_spr%d/gen_n_%d_%d_%d_%d' % (num_measurements,num_latents,num_measurements,num_latents,dim_latent,epoch)
        filename2 = os.getcwd()+'/DeepcsTF2_m%d_spr%d/meas_n_%d_%d_%d_%d' % (num_measurements,num_latents,num_measurements,num_latents,dim_latent,epoch)
        filename3 = os.getcwd()+'/DeepcsTF2_m%d_spr%d/genSpar_n_%d_%d_%d_%d' % (num_measurements,num_latents,num_measurements,num_latents,dim_latent,epoch)
        filename4 = os.getcwd()+'/DeepcsTF2_m%d_spr%d/measSpar_n_%d_%d_%d_%d' %(num_measurements,num_latents,num_measurements,num_latents,dim_latent,epoch)
...
mat_file = os.getcwd()+'/DeepcsTF2_m%d_spr%d/gen_n_%d_%d_%d.mat' % (num_measurements,num_latents,num_measurements,num_latents,dim_latent)
